...
public class DiffableCollectionSection: Hashable, Identifiable {
    public var id: Int
    var cells: [any DiffableCollectionCellProvider]
    var sectionLayout: NSCollectionLayoutSection
    var header: (any CollectionSupplementaryViewProvider)?
    var footer: (any CollectionSupplementaryViewProvider)?
    
    public init(_ id: Int, cells: [any DiffableCollectionCellProvider], header: (any CollectionSupplementaryViewProvider)? = nil, footer: (any CollectionSupplementaryViewProvider)? = nil, sectionLayout: NSCollectionLayoutSection) {
        self.cells = cells
        self.header = header
        self.footer = footer
        self.id = id
