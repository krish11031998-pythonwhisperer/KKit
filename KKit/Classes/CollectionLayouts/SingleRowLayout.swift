...
public extension NSCollectionLayoutSection {
    ...
    static func singleRowLayout(width: NSCollectionLayoutDimension, height: NSCollectionLayoutDimension, insets: NSDirectionalEdgeInsets = .init(by: 10), spacing: CGFloat = 8) -> NSCollectionLayoutSection {
